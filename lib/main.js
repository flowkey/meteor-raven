 ...
 * @param options object  Optionally add options, like a tag name & value eg: {
 *     tags: { component: 'charts' } } or the log level { level: 'warning' }
 */
function log(message, options) {
  ...
  if (message instanceof Error) {
    client.captureException(message, options);
  } else {
